...
public class ActivityLatitudeLongitudeListView extends AppCompatActivity {
    ...
    private void atualizarListView(){
        ...
        Cursor cursor = sqLiteDatabase.query("TblCoordenadas",new String[]{"_id","Latitude","Longitude"},null,null,null,null,null,null);
        this.listViewAdapter = new ListViewAdapterForSqliteCursor(this,cursor);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        Log.i("ActivityListView","public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {...");
