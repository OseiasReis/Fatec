...
public class Painel_Emprestimo extends JPanel {
	...
	public Painel_Emprestimo(Operador operador) {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (validarRegistro() == true) {
					...
					if (liberarEmprestimo() == true) {
						...
						JOptionPane.showMessageDialog(null, "Realização de empréstimo cancelada!");
					}
				} else {
					JOptionPane.showMessageDialog(null, "Registro inexistente ou cliente inativo!", "Erro", JOptionPane.ERROR_MESSAGE);
				}
			...
			public void actionPerformed(ActionEvent arg0) {
				if (validarCampos() == false) {
					...
					if (verificarExemplar(txtNumEx.getText()) != false) {
						...
						JOptionPane.showMessageDialog(null, "Exemplar " + erro, "Atenção", 2);
					}
