...
public class Painel_AlterarExemplar extends JPanel {
	...
	public Painel_AlterarExemplar() {
		...
		panelButtons.setLayout(new MigLayout("", "[grow][120]", "[35][35][35]"));
		
		btnAlterar = new JButton("Alterar");
		panelButtons.add(btnAlterar, "cell 1 1,grow");
		...
		panelButtons.add(btnCancelar, "cell 1 2,grow");
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(176)
							.addComponent(spDetalheFisico, GroupLayout.PREFERRED_SIZE, 273, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addComponent(rbNao)))
							.addGap(447)
							.addComponent(panelButtons, GroupLayout.PREFERRED_SIZE, 222, GroupLayout.PREFERRED_SIZE))))
		);
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(rbSim)
								.addComponent(rbNao)))
						.addComponent(panelButtons, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)))
		);
