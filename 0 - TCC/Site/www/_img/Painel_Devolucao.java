...
public class Painel_Devolucao extends JPanel {
	...
	public Painel_Devolucao(Operador operador) {
					...
					if (checarEmprestimo(txtNumEx.getText(), txtRegistro.getText()) == true) {
								...
								if (operador.getPrivilegio().equals("Administrador")) {
									if (!txtTerminoMulta.isVisible()) {
										...
										int confirm = JOptionPane.showConfirmDialog(null,
												...
												"Devolução atrasada", JOptionPane.YES_NO_CANCEL_OPTION);
										...
										if (verificarData(txtTerminoMulta.getDate()) == true) {
											...
											JOptionPane.showMessageDialog(null, "Selecione uma data válida!", "Erro",
									...
									if (verif_penalidade.getSuspensao_manual().equals(true)) {
										...
										if(verif_penalidade.getSuspensao_automatica().equals(true)){
											d.setTermino_suspensao(calcularTerminoSuspensao(atraso));
											JOptionPane.showMessageDialog(null, "Multa calculada com sucesso!", "Multa", JOptionPane.INFORMATION_MESSAGE);
										}else{
											JOptionPane.showMessageDialog(null, "Multa não aplicada!","Multa", JOptionPane.INFORMATION_MESSAGE);
										}
									}
								}
								atrasado = true;
						...
						if (aplicarmulta == false) {
							if (cancelar == false) {
								...
								if(atrasado == false)
									JOptionPane.showMessageDialog(null, "Devolucao realizada sem atraso!");
								else
								...
								*/
								...
								JOptionPane.showMessageDialog(null, "Devolução Cancelada!", "Cancelamento",
						...
						JOptionPane.showMessageDialog(null, "Exemplar não sofreu empréstimo/inexistente!", "Erro",
								JOptionPane.ERROR_MESSAGE);
					}

				} else {
					JOptionPane.showMessageDialog(null, "O cadastro contém campos inválidos!", "Atenção", 2);
				}
			}
		...
		btnValidar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (validarRegistro() == true) {
					...
					JOptionPane.showMessageDialog(null, "Registro inexistente!", "Erro", JOptionPane.ERROR_MESSAGE);
				}
