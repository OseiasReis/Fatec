...
public class Painel_AlterarCliente extends JPanel {
	...
	public Painel_AlterarCliente() {
			
		this.setSize(1360, 760);
		this.setLayout(new MigLayout("", "[50][87.00][50.00][80.00][50][86.00][60.00][64.00][50][68.00][][83.00][72.00][143.00]", "[45][][25][15][][25][15][][25][15][][25][15][][25][15][][25]"));
		...
		this.add(lblSexo, "cell 1 10,grow");
		...
		this.add(cbSexo, "cell 1 11 2 1,growx");
		...
		this.add(lblNasc, "cell 1 13,grow");
		...
		this.add(txtNascimento, "cell 1 14,grow");
		...
		rbDesativo = new JRadioButton("Desativo");
