                ...
                <section class="tx_preto center">
                    <?php
                        ...
                        if (empty($busca)) {
                            ...
                            echo "<h1>Por favor preencher o campo de busca.</h1>";
                            ...
                            // Monta uma consulta MySQL para a busca
                            $sql="SELECT * FROM acervo WHERE cod_classificacao LIKE '%$busca%'";
                            ...
                            if ($resultcount == 0) {
                                ...
                                echo "<h1>Nenhum resultado encontrado para este genero!</h1>";
