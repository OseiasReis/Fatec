                ...
                <section class="tx_preto center">
                    <?php
                        ...
                        if (empty($busca)) {
                            ...
                            // Monta uma consulta MySQL para a busca
                            $sql="SELECT * FROM acervo WHERE titulo LIKE '%$busca%' AND tipo_material Like '%$tipo%'";
                            ...
                            // Monta uma consulta MySQL para a busca
                            $sql="SELECT * FROM acervo WHERE titulo LIKE '%$busca%' AND cod_classificacao Like '%$genero%' AND tipo_material Like '%$tipo%'";
