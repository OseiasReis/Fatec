...
import java.net.URL;
public class CT02ConsultaComDadosInvalidosTest {
  ...
  @Test
  public void cT02ConsultaComDadosInvalidos() {
    driver.get("http://www.buscacep.correios.com.br/sistemas/buscacep/buscaCep.cfm");
    driver.manage().window().setSize(new Dimension(952, 526));
    ...
    assertThat(driver.switchTo().alert().getText(), is("Informe o nome da cidade, município, distrito ou povoado !"));
  }
}
