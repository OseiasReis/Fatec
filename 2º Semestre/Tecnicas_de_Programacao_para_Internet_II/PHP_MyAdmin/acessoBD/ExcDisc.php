<html>
<head> <title>PHP - Excluir Disc</title>
...
$sql = "SELECT * FROM disciplinas where coddisciplina = '$coddisc'";
$res = mysqlexecuta($con,$sql);
$quant = (mysql_num_rows ($res)); //quantidades de linhas encontradas na consulta
if ($quant == 0)
{
	echo "<p align='center'><b> <font color ='#ff0000'>Disciplina não encontrada!!! </font></b>"."<BR>";
}

else
	
{
$sql="delete FROM disciplinas where coddisciplina = '$coddisc'";
$res = mysqlexecuta($con,$sql);
